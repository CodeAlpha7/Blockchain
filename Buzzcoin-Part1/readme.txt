...
6) Learn Web3.py and use it to interact with the Buzzcoin contract. One potential
source is https://docs.moonbeam.network/builders/build/eth-api/libraries/web3py/
to learn how to send transactions and deploy contracts (which you will need in part 2
of this project that we will post soon).
