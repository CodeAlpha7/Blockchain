...
transaction = {'chainId': Chain_id, 'from': caller, 'nonce': nonce, 'gas': 2000000, 'gasPrice': web3.to_wei('1', 'gwei')}
# Call your function
call_function = contract.functions.problem5(14339427822313213406009919155762283766992156934624880009301049357915786044861).build_transaction(transaction)
