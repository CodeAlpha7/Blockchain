...
transaction = {'chainId': Chain_id, 'from': caller, 'nonce': nonce, 'gas': 1000000, 'gasPrice': web3.to_wei('1', 'gwei'),  'value': web3.to_wei(3.14159265, 'ether') }
# Call your function
call_function = contract.functions.problem4().build_transaction(transaction)
