...
transaction = {'chainId': Chain_id, 'from': caller, 'nonce': nonce, 'gas': 1000000, 'gasPrice': web3.to_wei('1', 'gwei'),  'value': web3.to_wei(5, 'ether') }
# Call your function
call_function = contract.functions.duel_highroller().build_transaction(transaction)
