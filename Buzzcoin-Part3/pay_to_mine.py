...
answer = 85909057649038376603584589246194504056543118360871623310654002482287652896768
d = 33
call_function = contract.functions.pay_to_mine(answer, d).build_transaction(transaction)
